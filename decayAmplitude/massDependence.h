...
namespace rpwa {
	...
	//////////////////////////////////////////////////////////////////////////////
	/// Brief polynomial mass dependence with felxible coefficients
	...
	private:
		...
		double _mMin;   ///< Lower limit of expansion range
		double _mMax;   ///< Upper limit of expansion range
	};
	...
	//////////////////////////////////////////////////////////////////////////////
	/// Brief complex TF1 mass dependence with felxible coefficients
	...
	public:
		...
		std::string getRealFunctionString() const { return _realFunctionString; }
		std::string getImagFunctionString() const { return _imagFunctionString; }
	private:
