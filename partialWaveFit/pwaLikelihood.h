...
namespace rpwa {
	...
	public:
		...
		typedef boost::multi_array<complexT,                                  3> productionAmpsArrayType; // array for production and decay amplitudes
	...
	public:
		...
		void copyFromParArray(const double*  inPar,              // input parameter array
		                      productionAmpsArrayType& outVal,          // output values organized as 3D array of complex numbers with [rank][reflectivity][wave index]
		                      value_type&    outFlatVal) const;  // output value corresponding to flat wave
		void copyFromParArray(const double*  inPar,              // input parameter array
		                      decayAmpsArrayType* outVal,          // output values organized as 3D array of complex numbers with [rank][reflectivity][wave index]
		                      value_type&    outFlatVal) const;  // output value corresponding to flat wave

		void copyToParArray(const productionAmpsArrayType& inVal,          // values corresponding to production amplitudes [rank][reflectivity][wave index]
		                    const value_type     inFlatVal,      // value corresponding to flat wave
		                    double*              outPar) const;  // output parameter array
		void copyToParArray(const decayAmpsArrayType* inVal,          // values corresponding to production amplitudes [rank][reflectivity][wave index]
		                    const value_type     inFlatVal,      // value corresponding to flat wave
		                    double*              outPar) const;  // output parameter array
